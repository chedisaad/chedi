...
public class Params extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//Récupérer les texte des zones
				String smail=mail.getText().toString();
				String smdp=mdp.getText().toString();
					Log.d("textinput", smail);

					
				//Instance de la classe Settings :Création des données dans l'XML
    ...
    public class ConnectTask extends AsyncTask<String, String, String>
    {
		...
		protected String doInBackground(String... params) {
			...
			//Une liste parames contenant deux types de paramètres
			...
			try {
					...
					if (success==1)
					{
						//Test sur le cas success : je vais stocké l'ID et je retourne success
