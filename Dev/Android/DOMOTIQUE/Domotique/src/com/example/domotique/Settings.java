...
public class Settings {
	...
	// Création d'un fichier ..Réellement un fichier XML pour le stockage des données
	//on va aussi faire les méthodes d'accé en lecture et on écriture
	...
	final String SH_Name="Domotique";
	
	//Constructeur
	public Settings(Context context) {
		super();
		this.context = context;
		//Mode 0: si fichier créer il ajoute dedant sinon il crée un nouveau
		pref=context.getSharedPreferences(SH_Name, 0);
		editor=pref.edit();
	}
	
	//Autorise l'écriture dans le fichier XML
	...
	public String getHost() {
		return pref.getString(host, "http://192.168.1.2/");
	}
